...
#return a json with the circle postions for different omega on the topic similarity matrix
...
@app.route("/scenario1")
def single_corpus(lda_model, corpus, id2word, relevantDocumentsDict, topic_similarity_matrix, PreparedDataObtained = None, data_dict = None):
    ...
    html = prepared_html_in_flask(data = [PreparedDataObtained], relevantDocumentsDict = relevantDocumentsDict_collection_1, topic_order = topic_order,  type_vis = 1,  new_circle_positions = new_circle_positions)
