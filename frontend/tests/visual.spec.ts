 ...
 * the baselines remain reproducible across machines without needing to
 * download the paper datasets (Cambridge Analytica + Gun Violence).
 * Phase 5 adds a `paper-figures` profile that reproduces the actual
 * paper figures and is run weekly in CI.
 */
