...
// === Modernization: explicit local for `jsonDataArray` (added during Vite/TS migration) ===
// In the script-tag deployment, the assignment `jsonDataArray = _;` inside
// `sankey.jsonDataArray()` below silently created a window global. Under
// bundler scope the implicit-global trick is a strict-mode ReferenceError,
// so we declare the variable explicitly at the closure scope.
d3.sankey = function() {
  var sankey = {},
      nodeWidth = 24,
      nodePadding = 8,
