...
!(function (t, e) {
    ...
    var Z,
        ...
        et = i(function (t) {
            ...
            (t.exports = function (t, e, r, a) {
                var s = !!a && !!a.unsafe,
                    l = !!a && !!a.enumerable,
                    c = !!a && !!a.noTargetGet;
                "function" == typeof r && ("string" != typeof e || w(r, "name") || A(r, "name", e), (i(r).source = n.join("string" == typeof e ? e : ""))),
                    t !== o ? (s ? !c && t[e] && (l = !0) : delete t[e], l ? (t[e] = r) : A(t, e, r)) : l ? (t[e] = r) : E(e, r);
        ...
        Mt = function () {
            ...
            Mt = Z
                ...
                : (((e = k("iframe")).style.display = "none"), Vt.appendChild(e), (e.src = String("javascript:")), (t = e.contentWindow.document).open(), t.write(Ht("document.F=Object")), t.close(), t.F);
    ...
    var Ut =
        ...
        ie = Xt("toStringTag"),
        ne = function (t, e, i) {
            t && !w((t = i ? t : t.prototype), ie) && ee(t, ie, { configurable: !0, value: e });
        },
        oe = function (t) {
        ...
        Ae = function (t, e) {
            ...
            return fe(i, { type: "Symbol", tag: t, description: e }), a || (i.description = e), i;
        },
        Ee =
        ...
        Re = function (t, e, i) {
            t === ge && Re(ke, e, i), P(t);
            var n = m(e, !0);
            return P(i), w(xe, n) ? (i.enumerable ? (w(t, ue) && t[ue][n] && (t[ue][n] = !1), (i = Ut(i, { enumerable: h(0, !1) }))) : (w(t, ue) || ye(t, ue, h(1, {})), (t[ue][n] = !0)), Ie(t, n, i)) : ye(t, n, i);
        },
        je = function (t, e) {
            P(t);
            var i = v(e),
    ...
    if (
        ...
        Et({ target: "Object", stat: !0, forced: !Rt }, { getOwnPropertyNames: _e, getOwnPropertySymbols: Be }),
        Et(
            {
                target: "Object",
                stat: !0,
    ...
    var ki,
        ...
        Ai = Xt("iterator"),
        Ei = !1;
    [].keys && ("next" in (Ci = [].keys()) ? (Oi = Ii(Ii(Ci))) !== Object.prototype && (ki = Oi) : (Ei = !0)),
        null == ki && (ki = {}),
        w(ki, Ai) ||
            A(ki, Ai, function () {
                return this;
    ...
    var Ri = { IteratorPrototype: ki, BUGGY_SAFARI_ITERATORS: Ei },
        ...
        Li = function (t, e, i, n, o, r, a) {
            ...
            if (
                (b && ((s = Ii(b.call(new t()))), Fi !== Object.prototype && s.next && (Ii(s) !== Fi && (Ni ? Ni(s, Fi) : "function" != typeof s[Bi] && A(s, Bi, Vi)), ne(s, d, !0))),
                "values" == o &&
                    g &&
                    "values" !== g.name &&
                    ((f = !0),
                ...
                if (((l = { values: u("values"), keys: r ? v : u("keys"), entries: u("entries") }), a)) for (c in l) (!_i && !f && c in p) || et(p, c, l[c]);
    ...
    if (It("Number", !yn(" 0o1") || !yn("0b1") || yn("+0x1"))) {
        for (
            var kn,
                ...
                Cn = a ? gn(yn) : "MAX_VALUE,MIN_VALUE,NaN,NEGATIVE_INFINITY,POSITIVE_INFINITY,EPSILON,isFinite,isInteger,isNaN,isSafeInteger,MAX_SAFE_INTEGER,MIN_SAFE_INTEGER,parseFloat,parseInt,isInteger".split(","),
                Tn = 0;
            Cn.length > Tn;
            Tn++
        )
    ...
    var Pn = Object.assign,
        ...
        In =
            ...
            r(function () {
                ...
                : Pn;
    Et({ target: "Object", stat: !0, forced: Object.assign !== In }, { assign: In });
    var An = c.f,
        En = function (t) {
            return function (e) {
        ...
        (Zn = function (t) {
            ...
            return (
                a &&
                    ...
                    r.lastIndex > 0 && (!r.multiline || (r.multiline && "\n" !== t[r.lastIndex - 1])) && ((l = "(?: " + l + ")"), (h = " " + h), c++),
                    (i = new RegExp("^(?:" + l + ")", s))),
                io && (i = new RegExp("^" + l + "$(?!\\s)", s)),
                to && (e = r.lastIndex),
                (n = Xn.call(a ? i : r, h)),
                a ? (n ? ((n.input = n.input.slice(c)), (n[0] = n[0].slice(c)), (n.index = r.lastIndex), (r.lastIndex += n[0].length)) : (r.lastIndex = 0)) : to && n && (r.lastIndex = r.global ? n.index + n[0].length : e),
                io &&
                    n &&
                    n.length > 1 &&
            ...
            return function (e, i) {
                ...
                return a < 0 || a >= s
                    ? t
                        ? ""
                        : void 0
                    : (n = r.charCodeAt(a)) < 55296 || n > 56319 || a + 1 === s || (o = r.charCodeAt(a + 1)) < 56320 || o > 57343
                    ? t
                        ? r.charAt(a)
                        : n
                    : t
    ...
    Li(
        ...
        function () {
            var t,
                ...
                i = e.string,
                n = e.index;
            return n >= i.length ? { value: void 0, done: !0 } : ((t = go(i, n)), (e.index += t.length), { value: t, done: !1 });
        }
    );
    var mo = Xt("species"),
        yo = !r(function () {
            ...
            if (!a || !s || ("replace" === t && (!yo || !wo)) || ("split" === t && !So)) {
                var l = /./[o],
                    c = i(
                        ...
                        ""[t],
                        function (t, e, i, n, o) {
                            return e.exec === no ? (a && !o ? { done: !0, value: l.call(e, i, n) } : { done: !0, value: t.call(i, e, n) }) : { done: !1 };
                        },
                        { REPLACE_KEEPS_$0: wo }
                    ),
                    h = c[0],
                ...
                (n =
                    "c" == "abbc".split(/(b)*/)[1] || 4 != "test".split(/(?:)/, -1).length || 2 != "ab".split(/(?:ab)*/).length || 4 != ".".split(/(.?)(.?)/).length || ".".split(/()()/).length > 1 || "".split(/.?/).length
                        ? function (t, i) {
                              ...
                              for (
                                  var r, a, s, l = [], c = (t.ignoreCase ? "i" : "") + (t.multiline ? "m" : "") + (t.unicode ? "u" : "") + (t.sticky ? "y" : ""), h = 0, u = new RegExp(t.source, c + "g");
                                  (r = no.call(u, n)) && !((a = u.lastIndex) > h && (l.push(n.slice(h, r.index)), r.length > 1 && r.index < n.length && jo.apply(l, r.slice(1)), (s = r[0].length), (h = a), l.length >= o));
    ...
    var hr = {
                        ...
                        (s._id = t(a).attr("id")),
                            ...
                            t(a)
                                ...
                                .each(function (o, a) {
                                    ...
                                    for (var u = h; u < h + l; u++) for (var d = i; d < i + c; d++) r[d] || (r[d] = []), (r[d][u] = !0);
                                    var f = e[h].field;
                                    (s[f] = t(a).html().trim()),
                                        ...
                                        (s["_".concat(f, "_data")] = n.getRealDataAttr(t(a).data()));
                                }),
                            o.push(s);
                    }),
                    o
            ...
            sort: function (t, e, i, n, o, r) {
                return (
                    ...
                    null == e && (e = ""),
                    n && t === e && ((t = o), (e = r)),
                    this.isNumeric(t) && this.isNumeric(e) ? ((t = parseFloat(t)) < (e = parseFloat(e)) ? -1 * i : t > e ? i : 0) : t === e ? 0 : ("string" != typeof t && (t = t.toString()), -1 === t.localeCompare(e) ? -1 * i : i)
                );
            },
            ...
            return (
                Zo(e, [
                        ...
                        value: function () {
                            if (this.options.locale) {
                                ...
                                (i[0] = i[0].toLowerCase()),
                                    ...
                                    e[this.options.locale] ? t.extend(this.options, e[this.options.locale]) : e[i.join("-")] ? t.extend(this.options, e[i.join("-")]) : e[i[0]] && t.extend(this.options, e[i[0]]);
                            }
                        },
                    },
                    {
                            ...
                            (this.$container = t(
                                ...
                                this.options.height &&
                                    ...
                                    this.options.classes.split(" ").includes("table-bordered") &&
                                        (this.$tableBody.append('<div class="fixed-table-border"></div>'), (this.$tableBorder = this.$tableBody.find(".fixed-table-border")), this.$tableLoading.addClass("fixed-table-border")),
                            ...
                            (this.$header = this.$el.find(">thead")),
                                ...
                                this.$header.find("tr").each(function (e, i) {
                                    ...
                                    t(i)
                                        .find("th")
                                        .each(function (e, i) {
                                            void 0 !== t(i).data("field") && t(i).data("field", "".concat(t(i).data("field"))),
                                                o.push(
                                                    t.extend(
                                                        {},
                                                        {
                                ...
                                this.options.data.length || ((this.options.data = hr.trToData(this.columns, this.$el.find(">tbody>tr"))), this.options.data.length && (this.fromHtml = !0)),
                                (this.footerData = hr.trToData(this.columns, this.$el.find(">tfoot>tr"))),
                                ...
                                this.options.columns.forEach(function (t, o) {
                                    n.push("<tr>"),
                                        0 === o &&
                                            ...
                                            n.push('<th class="detail" rowspan="'.concat(e.options.columns.length, '">\n          <div class="fht-cell"></div>\n          </th>\n        ')),
                                        t.forEach(function (t, r) {
                                            ...
                                            if (((u += hr.sprintf("width: %s; ", (!t.checkbox && !t.radio) || l ? (l ? l + s : void 0) : t.showSelectTitle ? void 0 : "36px")), void 0 !== t.fieldIndex || t.visible)) {
                                                ...
                                                n.push(
                                                    "<th".concat(hr.sprintf(' title="%s"', t.titleTooltip)),
                                                    t.checkbox || t.radio ? hr.sprintf(' class="bs-checkbox %s"', t.class || "") : p || a,
                                                    ...
                                                    n.push(hr.sprintf('<div class="th-inner %s">', e.options.sortable && t.sortable ? "sortable both" : ""));
                                                var w = e.options.escape ? hr.escapeHTML(t.title) : t.title,
                                                    S = w;
                                                t.checkbox &&
                                                    ((w = ""), !e.options.singleSelect && e.options.checkboxHeader && (w = '<label><input name="btSelectAll" type="checkbox" /><span></span></label>'), (e.header.stateField = t.field)),
                                                    t.radio && ((w = ""), (e.header.stateField = t.field)),
                    ...
                    },
                    {
                        key: "initData",
                        value: function (t, e) {
                            (this.options.data = "append" === e ? this.options.data.concat(t) : "prepend" === e ? [].concat(t).concat(this.options.data) : t || this.options.data),
                        ...
                        value: function () {
                            ...
                            -1 !== n &&
                                ...
                                this.options.customSort
                                    ? hr.calculateObjectValue(this.options, this.options.customSort, [this.options.sortName, this.options.sortOrder, this.data])
                                ...
                                this.options.sortName === o.data("field")
                                    ...
                                    : ((this.options.sortName = o.data("field")),
                                      this.options.rememberOrder
                                          ...
                                          : (this.options.sortOrder = this.columns[this.fieldsColumnsIndex[o.data("field")]].sortOrder || this.columns[this.fieldsColumnsIndex[o.data("field")]].order)),
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            this.$toolbar.find(".bs-bars").children().length && t("body").append(t(n.toolbar)),
                                this.$toolbar.html(""),
                                ("string" != typeof n.toolbar && "object" !== Yo(n.toolbar)) || t(hr.sprintf('<div class="bs-bars %s-%s"></div>', this.constants.classes.pull, n.toolbarAlign)).appendTo(this.$toolbar).append(t(n.toolbar)),
                                ...
                                "string" == typeof n.icons && (n.icons = hr.calculateObjectValue(null, n.icons));
                            var s = {
                                paginationSwitch: '<button class="'
                                    .concat(this.constants.buttonsClass, '" type="button" name="paginationSwitch"\n        aria-label="Pagination Switch" title="')
                                ...
                                refresh: '<button class="'
                                    .concat(this.constants.buttonsClass, '" type="button" name="refresh"\n        aria-label="Refresh" title="')
                                ...
                                toggle: '<button class="'
                                    .concat(this.constants.buttonsClass, '" type="button" name="toggle"\n        aria-label="Toggle" title="')
                                ...
                                fullscreen: '<button class="'
                                    .concat(this.constants.buttonsClass, '" type="button" name="fullscreen"\n        aria-label="Fullscreen" title="')
                                ...
                                columns: (function () {
                                    ...
                                    if (
                                        ...
                                        n.showColumnsSearch &&
                                            (t.push(
                                                hr.sprintf(
                                                    ...
                                                    hr.sprintf('<input type="text" class="%s" id="columnsSearch" placeholder="%s" autocomplete="off">', i.constants.classes.input, n.formatSearch())
                                                )
                                            ),
                                        ...
                                        t.push(hr.sprintf(i.constants.html.toolbarDropdownItem, hr.sprintf('<input type="checkbox" class="toggle-all" %s> <span>%s</span>', e ? 'checked="checked"' : "", n.formatColumnsToggleAll()))),
                                            t.push(i.constants.html.toolbarDropdownSeparator);
                                    }
                                    var o = 0;
                                    return (
                                        ...
                                        i.columns.forEach(function (e, r) {
                                            if (!i.isSelectionColumn(e) && (!n.cardView || e.cardVisible)) {
                                                ...
                                                e.switchable &&
                                                    (t.push(hr.sprintf(i.constants.html.toolbarDropdownItem, hr.sprintf('<input type="checkbox" data-chkbox-shiftsel="%s" data-field="%s" value="%s"%s%s> <span>%s</span>', e.field, r, s, l, e.title))), a++);
                                            }
                                        }),
                            ...
                            if (
                                (o.push("</div>"),
                                (this.showToolbar || o.length > 2) && this.$toolbar.append(o.join("")),
                            ...
                            if (n.search || this.showSearchClearButton) {
                                ...
                                var m = hr.sprintf(
                                        ...
                                        n.formatSearch(),
                                        n.showButtonIcons ? hr.sprintf(this.constants.html.icon, n.iconsPrefix, n.icons.search) : "",
                                    ...
                                    y = hr.sprintf(
                                        ...
                                        this.constants.buttonsClass,
                                        n.formatClearSearch(),
                                        n.showButtonIcons ? hr.sprintf(this.constants.html.icon, n.iconsPrefix, n.icons.clearSearch) : "",
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            if (e.pagination) {
                                ...
                                if (
                                    (c.push('<div class="'.concat(this.constants.classes.pull, "-").concat(e.paginationDetailHAlign, ' pagination-detail">\n      <span class="pagination-info">\n      ').concat(f, "\n      </span>")),
                                    ...
                                    d.forEach(function (i, n) {
                                        ...
                                        (!e.smartDisplay || 0 === n || d[n - 1] < e.totalRows) &&
                                            ((o = h ? (i === e.formatAllRows() ? t.constants.classes.dropdownActive : "") : i === e.pageSize ? t.constants.classes.dropdownActive : ""),
                                            p.push(hr.sprintf(t.constants.html.pageDropdownItem, o, i)));
                                    }),
                                        p.push("".concat(this.constants.html.pageDropdown[1], "</span>")),
                                        c.push(e.formatRecordsPerPage(p.join(""))),
                                        c.push("</span></div>"),
                                        c.push(
                                            '<div class="'.concat(this.constants.classes.pull, "-").concat(e.paginationHAlign, ' pagination">'),
                                            hr.sprintf(this.constants.html.pagination[0], hr.sprintf(" pagination-%s", e.iconSize)),
                                            hr.sprintf(this.constants.html.paginationItem, " page-pre", e.formatSRPaginationPreText(), e.paginationPreText)
                                        ),
                                        this.totalPages < e.paginationSuccessivelySize ? ((n = 1), (o = this.totalPages)) : (o = (n = e.pageNumber - e.paginationPagesBySide) + 2 * e.paginationPagesBySide),
                                        ...
                                        n - 1 === b + 1
                                            ...
                                            : n - 1 > b &&
                                              (n - 2 * e.paginationPagesBySide > e.paginationPagesBySide && e.paginationUseIntermediate
                                                  ...
                                                  : c.push(hr.sprintf(this.constants.html.paginationItem, " page-first-separator disabled", "", "...")));
                                    }
                                                ...
                                                o + 1 === m - 1
                                                    ...
                                                    : m > o + 1 &&
                                                      (this.totalPages - o > 2 * e.paginationPagesBySide && e.paginationUseIntermediate
                                                          ? ((i = Math.round((this.totalPages - g - o) / 2 + o)), c.push(v(i, " page-intermediate")))
                                                          : c.push(hr.sprintf(this.constants.html.paginationItem, " page-last-separator disabled", "", "..."))),
                                                i = m;
                                            i <= this.totalPages;
                                            i++
                                        )
                    ...
                    },
                    {
                        ...
                        value: function (e) {
                            ...
                            return (
                                i.parent().addClass(this.constants.classes.dropdownActive).siblings().removeClass(this.constants.classes.dropdownActive),
                            ...
                            if (!(hr.findIndex(this.hiddenRows, t) > -1)) {
                                ...
                                return (
                                    r.push(
                                        ...
                                        hr.sprintf(' class="%s"', a.classes || (Array.isArray(t) ? void 0 : t._class)),
                                        ' data-index="'.concat(e, '"'),
                                        hr.sprintf(' data-uniqueid="%s"', hr.getItemField(t, this.options.uniqueId, !1)),
                                        hr.sprintf(' data-has-detail-view="%s"', !this.options.cardView && this.options.detailView && hr.calculateObjectValue(null, this.options.detailFilter, [e, t]) ? "true" : void 0),
                                        hr.sprintf("%s", l),
                                        ">"
                                    ),
                                    this.options.cardView && r.push('<td colspan="'.concat(this.header.fields.length, '"><div class="card-views">')),
                                    !this.options.cardView &&
                                        this.options.detailView &&
                                        this.options.detailViewIcon &&
                                        (r.push("<td>"),
                                        hr.calculateObjectValue(null, this.options.detailFilter, [e, t]) &&
                                            r.push(
                                    ...
                                    this.header.fields.forEach(function (i, n) {
                                        ...
                                        if ((!o.fromHtml || void 0 !== l || y.checkbox || y.radio) && y.visible && (!o.options.cardView || y.cardVisible)) {
                                            if (
                                                ...
                                                s.concat([o.header.styles[n]]).length && (p = ' style="'.concat(s.concat([o.header.styles[n]]).join("; "), '"')),
                                                t["_".concat(i, "_id")] && (d = hr.sprintf(' id="%s"', t["_".concat(i, "_id")])),
                                                t["_".concat(i, "_class")] && (f = hr.sprintf(' class="%s"', t["_".concat(i, "_class")])),
                                                t["_".concat(i, "_rowspan")] && (v = hr.sprintf(' rowspan="%s"', t["_".concat(i, "_rowspan")])),
                                                t["_".concat(i, "_colspan")] && (b = hr.sprintf(' colspan="%s"', t["_".concat(i, "_colspan")])),
                                                t["_".concat(i, "_title")] && (m = hr.sprintf(' title="%s"', t["_".concat(i, "_title")])),
                                                (u = hr.calculateObjectValue(o.header, o.header.cellStyles[n], [l, t, e, i], u)).classes && (f = ' class="'.concat(u.classes, '"')),
                                                u.css)
                                            ) {
                                            ...
                                            if (y.checkbox || y.radio) {
                                                ...
                                                (a = [
                                                    o.options.cardView ? '<div class="card-view '.concat(E, '">') : '<td class="bs-checkbox '.concat(E, '"').concat(f).concat(p, ">"),
                                                    '<label>\n            <input\n            data-index="'
                                                        .concat(e, '"\n            name="')
                    ...
                    },
                    {
                        ...
                        value: function (e) {
                            ...
                            this.trigger("pre-body", n),
                                ...
                                (this.options.pagination && "server" !== this.options.sidePagination) || ((this.pageFrom = 1), (this.pageTo = n.length));
                            ...
                            a
                                ? this.options.virtualScroll
                                    ...
                                    : this.$body.html(r)
                                : this.$body.html('<tr class="no-records-found">'.concat(hr.sprintf('<td colspan="%s">%s</td>', this.$header.find("th").length, this.options.formatNoMatches()), "</tr>")),
                                e || this.scrollTo(0),
                                this.initBodyEvent(),
                                this.updateSelected(),
                                this.initFooter(),
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            this.$body
                                ...
                                .on("click dblclick", function (i) {
                                    ...
                                    if (!n.find(".detail-icon").length) {
                                        if (
                                            ...
                                            "click" === i.type && e.options.clickToSelect && u.clickToSelect && !hr.calculateObjectValue(e.options, e.options.ignoreClickToSelectOn, [i.target]))
                                        ) {
                                ...
                                (this.$selectItem = this.$body.find(hr.sprintf('[name="%s"]', this.options.selectItemName))),
                        ...
                        value: function (e, i, n) {
                            ...
                            if (
                                ...
                                this.options.pagination &&
                                    ...
                                    ((s.pageSize = this.options.pageSize === this.options.formatAllRows() ? this.options.totalRows : this.options.pageSize), (s.pageNumber = this.options.pageNumber)),
                                (n || this.options.url || this.options.ajax) &&
                                    ...
                                    hr.isEmptyObject(this.filterColumnsPartial) || (s.filter = JSON.stringify(this.filterColumnsPartial, null)),
                                    t.extend(s, i || {}),
                                    !1 !== (r = hr.calculateObjectValue(this.options, this.options.queryParams, [s], r))))
                            ) {
                                e || this.showLoading();
                                var l = t.extend({}, hr.calculateObjectValue(null, this.options.ajaxOptions), {
                                    ...
                                    success: function (t, i, n) {
                                        ...
                                        o.load(r),
                                            ...
                                            e || o.hideLoading(),
                                            "server" === o.options.sidePagination && r[o.options.totalField] > 0 && !r[o.options.dataField].length && o.updatePagination();
                                    },
                                    error: function (t) {
                                        var i = [];
                                ...
                                try {
                                    for (var r, a = this.columns[Symbol.iterator](); !(i = (r = a.next()).done); i = !0) {
                                        ...
                                        if (c.visible) {
                                            ...
                                            if (
                                                ((s = hr.sprintf("text-align: %s; ", c.falign ? c.falign : c.align)),
                                                (l = hr.sprintf("vertical-align: %s; ", c.valign)),
                                                (u = hr.calculateObjectValue(null, this.options.footerStyle, [c])) && u.css)
                                            )
                                            ...
                                            u && u.classes && (d = hr.sprintf(' class="%s"', c.class ? [c.class, u.classes].join(" ") : u.classes)),
                                                e.push("<th", d, hr.sprintf(' style="%s"', s + l + h.concat().join("; ")), ">"),
                                                e.push('<div class="th-inner">'),
                                                e.push(hr.calculateObjectValue(c, c.footerFormatter, [t], (this.footerData[0] && this.footerData[0][c.field]) || "")),
                                                e.push("</div>"),
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            ...
                            if (
                                ((!(this.searchText || this.options.customSearch || this.options.sortName) && hr.isEmptyObject(this.filterColumns) && hr.isEmptyObject(this.filterColumnsPartial)) || (t && t.unfiltered) || (e = this.data),
                                t && t.useCurrentPage && (e = e.slice(this.pageFrom - 1, this.pageTo)),
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            ...
                            this.options.pagination && "server" === this.options.sidePagination && (this.options.totalRows = i[this.options.totalField]),
                                this.options.pagination && "server" === this.options.sidePagination && (this.options.totalNotFiltered = i[this.options.totalNotFilteredField]),
                                (e = i.fixedScroll),
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            ...
                            if (t.hasOwnProperty("field") && t.hasOwnProperty("values")) {
                                for (e = n - 1; e >= 0; e--)
                                    (i = this.options.data[e]).hasOwnProperty(t.field) && t.values.includes(i[t.field]) && (this.options.data.splice(e, 1), "server" === this.options.sidePagination && (this.options.totalRows -= 1));
                            ...
                            try {
                                for (var a, s = i[Symbol.iterator](); !(n = (a = s.next()).done); n = !0) {
                                    ...
                                    l.hasOwnProperty("index") &&
                                        ...
                                        (t.extend(this.options.data[l.index], l.row), l.hasOwnProperty("replace") && l.replace ? (this.options.data[l.index] = l.row) : t.extend(this.options.data[l.index], l.row));
                                }
                            } catch (t) {
                                (o = !0), (r = t);
                            } finally {
                        ...
                        value: function (t, e) {
                            ...
                            if (((n[this.header.stateField] = t), this.options.multipleSelectRow)) {
                                if (this.multipleSelectRowShiftKey && this.multipleSelectRowLastSelectedIndex >= 0)
                                    for (var c = [this.multipleSelectRowLastSelectedIndex, e].sort(), h = c[0] + 1; h < c[1]; h++)
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            ...
                            if (
                                ...
                                !this.options.cardView && this.options.showFooter && (this.$tableFooter.show(), this.fitFooter(), this.options.height && (e += this.$tableFooter.outerHeight(!0))),
                                ...
                                if ((this.$tableContainer.css("height", "".concat(o, "px")), this.$tableBorder)) {
                                    var s = o - a - 2;
                                    this.$tableBody[0].scrollWidth - this.$tableBody.innerWidth() && (s -= hr.getScrollBarWidth()),
                                        this.$tableBorder.css("width", "".concat(r.outerWidth(), "px")),
                                        this.$tableBorder.css("height", "".concat(s, "px"));
                                }
                            }
                            this.options.cardView
                                ? (this.$el.css("margin-top", "0"), this.$tableContainer.css("padding-bottom", "0"), this.$tableFooter.hide())
                    ...
                    },
                    {
                        key: "filterBy",
                        value: function (e, i) {
                            (this.filterOptions = hr.isEmptyObject(i) ? this.options.filterOptions : t.extend(this.options.filterOptions, i)),
                    ...
                    },
                    {
                        ...
                        value: function (t, e) {
                            ...
                            if (!n.next().is("tr.detail-view")) {
                                this.options.detailViewIcon && n.find("a.detail-icon").html(hr.sprintf(this.constants.html.icon, this.options.iconsPrefix, this.options.icons.detailClose)),
                                    n.after(hr.sprintf('<tr class="detail-view"><td colspan="%s"></td></tr>', n.children("td").length));
                    ...
                    },
                    {
                        ...
                        value: function (t) {
                            ...
                            i.next().is("tr.detail-view") &&
                                (this.options.detailViewIcon && i.find("a.detail-icon").html(hr.sprintf(this.constants.html.icon, this.options.iconsPrefix, this.options.icons.detailOpen)),
                    ...
                    },
                    {
                        ...
                        value: function (e) {
                            e.hasOwnProperty("field") &&
                                ...
                                ((this.columns[this.fieldsColumnsIndex[e.field]].title = this.options.escape ? hr.escapeHTML(e.title) : e.title),
                                this.columns[this.fieldsColumnsIndex[e.field]].visible &&
                                    (void 0 !== this.options.height ? this.$tableHeader : this.$header).find("th[data-field]").each(function (i, n) {
