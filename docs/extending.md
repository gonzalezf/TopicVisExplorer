...
> Phase 4h stub. Will be expanded into a full how-to guide for v1.0.
...
*Last updated: Phase 4h (April 2026). v1.0 release ships with this
guide expanded into a full Sphinx site under `docs/site/`.*
